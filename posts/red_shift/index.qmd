...
Given these differences, we might ask "what do the official statistics say?". While this is a sensible question, there is one problem: there aren't any. [The House of Parliament library does host data on elections since 1918](https://commonslibrary.parliament.uk/research-briefings/cbp-8647/). Yet most of these data are second hand and exist only thanks to psephologists like FWS Craig who had the foresight to collect them at the time.
